...
BENCHMARK_WITH_NAME("any_shared_ptr_cast",BM_any_ptr_cast);
...
BENCHMARK_WITH_NAME("any_shared_ptr_cast - implicit up cast",BM_any_ptr_implicit_up_cast);
...
BENCHMARK_WITH_NAME("any_shared_ptr_cast - failure", BM_any_ptr_bad_cast);
